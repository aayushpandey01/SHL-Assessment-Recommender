...
**Candidate submission | AI Research Intern Role | SHL Labs**
...
**Refusal scope**: Off topic detection uses two mechanisms regex patterns for known prompt-injection phrases, and a whitelist of hiring-context signals. A message with no hiring context and a very of topic signal (weather, recipes, etc.) is refused.
